		...
		$options = array(
			...
			'general' => array(
				...
				'options' => array(
					...
					// 	"std"         => "normal",
					// 	"options"     => array (
					// 		'clean' => __( 'Clean icons (No Background)', 'zn_framework' ),
					...
					array (
						...
						"options"     => array(
							array(
								...
								'desc'  => __( 'Icons without a background.', 'zn_framework' ),
								// 'image' => THEME_BASE_URI .'/pagebuilder/elements/TH_ImageBox/img/simple.png'
							),
							array(
								'value' => 'custom',
								'name'  => __( 'Custom Colored', 'zn_framework' ),
								'desc'  => __( 'Total control over the icons normal and hover colors.', 'zn_framework' ),
								// 'image' => THEME_BASE_URI .'/pagebuilder/elements/TH_ImageBox/img/style4.png'
							),
							array(
								'value' => 'normal',
								'name'  => __( 'Normal Icons', 'zn_framework' ),
								'desc'  => __( 'Dark background on normal state, theme-color on hover.', 'zn_framework' ),
								// 'image' => THEME_BASE_URI .'/pagebuilder/elements/TH_ImageBox/img/style1.png'
							),
							array(
								'value' => 'colored',
								'name'  => __( 'Colored icons (not recommended)', 'zn_framework' ),
								'desc'  => __( 'Custom colored on normal state, dark background on hover. These are deprecated, use Custom Colored instead.', 'zn_framework' ),
								// 'image' => THEME_BASE_URI .'/pagebuilder/elements/TH_ImageBox/img/style2.png'
							),
							array(
								'value' => 'colored_hov',
								'name'  => __( 'Colored on Hover icons (not recommended)', 'zn_framework' ),
								'desc'  => __( 'Dark background on normal state, custom colors on hover. These are deprecated, use Custom Colored instead.', 'zn_framework' ),
